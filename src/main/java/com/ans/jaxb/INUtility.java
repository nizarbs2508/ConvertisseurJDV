...
public final class INUtility {
	...
	public static List<Locale> getSupportedLocales() {
		return new ArrayList<>(Arrays.asList(Locale.FRENCH, Locale.ENGLISH));
	}
	 ...
	 * @return Button
	 */
	public static SplitMenuButton splitMenuButtonForKey(final String key, final Object... args) {
	 ...
	 * @return Button
	 */
	public static TitledPane titledPaneForKey(final String key, final Object... args) {
		final TitledPane button = new TitledPane();
		button.textProperty().bind(createStringBinding(key, args));
		return button;
	}
