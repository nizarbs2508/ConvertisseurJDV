...
public final class DateTimePicker extends DatePicker {
	 ...
	 * InternalConverter
	 */
	private final class InternalConverter extends StringConverter<LocalDate> {
		/**
		 * DEFAULT
		 */
		public static final LocalDate DEFAULT = null;
		/**
		 * InternalConverter constructor
		 */
		...
		public String toString(final LocalDate object) {
			...
			final LocalDateTime value = getDateTimeValue();
		...
		public LocalDate fromString(final String value) {
			...
			if (value == null || value.isEmpty()) {
				...
				local = dateTimeValue.get().toLocalDate();
			}
			return local;
		}
	}
